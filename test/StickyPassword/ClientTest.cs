...
namespace PasswordManagerAccess.Test.StickyPassword
{
    ...
    public class ClientTest
    {
        ...
        {
            var flow = new RestFlow().Post(ResponseWithError4002).Post(ResponseWithError4003);
        ...
        {
            var flow = new RestFlow().Post(ResponseWithError4002).Post(GetTokenResponse).ExpectContent($"pin={EmailPasscode}");

            var (token, passcode) = Client.GetEncryptedTokenAndPasscode(Username, DeviceId, GetPasscodeProvidingUi(), flow);
        ...
        {
            var flow = new RestFlow().Post(GetTokenResponse).ExpectContent($"pin={EmailPasscode}");
        ...
        public void AuthorizeDevice_makes_POST_request_with_specific_url_and_parameters()
        {
            ...
            Client.AuthorizeDevice(Username, Token, DeviceId, DeviceName, EmailPasscode, Timestamp, flow.ToRestClient(BaseUrl));
        }
        ...
        {
            var flow = new RestFlow().Post(GetS3TokenResponse).ExpectUrl("https://spcb.stickypassword.com/SPCClient/GetS3Token");
        ...
        public void GetS3Token_throws_on_non_zero_status()
        {
            ...
            Exceptions.AssertThrowsInternalError(
                () => Client.GetS3Token(Username, Token, DeviceId, Timestamp, flow),
        ...
        {
            var flow = new RestFlow().Get(VersionInfo.ToBytes()).ExpectUrl(Bucket).ExpectUrl(ObjectPrefix).ExpectUrl("spc.info");
        ...
        public void FindLatestDbVersion_throws_on_invalid_format(string response)
        {
            ...
            Exceptions.AssertThrowsInternalError(() => Client.FindLatestDbVersion(S3Token, flow), "Invalid database info format");
        }
        ...
        {
            var flow = new RestFlow().Get("".ToBytes()).ExpectUrl(Bucket).ExpectUrl(ObjectPrefix).ExpectUrl(Version);
        ...
        public void DownloadDb_throws_on_invalid_deflated_content()
        {
            ...
            Exceptions.AssertThrowsInternalError(() => Client.DownloadDb(Version, S3Token, flow), "Failed to decompress the database");
        }
        ...
        public void Post_converts_date_to_utc_and_formats_correctly()
        {
            ...
            var flow = new RestFlow().Post(SuccessfulResponse).ExpectHeader("Date", "Tue, 17 Mar 2020 11:34:56 GMT"); // UTC/GMT time here
        ...
        public void Post_sets_common_headers()
        {
            var flow = new RestFlow()
                ...
                .ExpectHeader("Authorization", "Basic TGFzdFBhc3MuUnVieUBnbWFpTC5jT206WlRRMU1HVmpNMlJsWlRRMk5HTTNaV0V4TlRoallqY3dOMlk0Tm1NMU1tUT0=")
                .ExpectHeader("Date", "Fri, 06 Mar 1998 17:24:56 GMT")
                .ExpectHeader("User-Agent", $"SP/8.0.3436 Prot=2 ID={DeviceId} Lng=EN Os=Android/4.4.4 Lic= LicStat= PackageID=");
    ...
    public class IsolatedThreadClientTest
    {
        ...
        public void GetEncryptedToken_formats_date_in_en_culture()
        {
            ...
            try
            {
                ...
                var flow = new RestFlow().Post(GetTokenResponse).ExpectHeader("Date", "Tue, 17 Mar 2020 11:34:56 GMT"); // UTC/GMT time here

                Client.GetEncryptedToken(
                    Username,
                    DeviceId,
                    NoPasscode,
    ...
    internal static class ClientTestData
    {
        ...
        internal static readonly DateTime Timestamp = new DateTime(
            year: 1998,
            month: 3,
            day: 6,
            hour: 17,
        ...
        internal static readonly S3Token S3Token = new S3Token("access-key-id", "secret-access-key", "security-token", Bucket, ObjectPrefix);
