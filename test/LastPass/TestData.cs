...
namespace PasswordManagerAccess.Test.LastPass
{
    static class TestData
    {
        ...
        {
            "LPAV", "PREM", "ENTU", "ENTM", "ENTA", "ATVR", "ENCU", "CBCU", "BBTE", "IPTE", "WMTE", "ANTE", "DOTE",
            "FETE", "FUTE", "SYTE", "WOTE", "TATE", "WPTE", "PRIK", "SPMT", "PREF", "NMAC", "ACCT", "NEVR", "SOSS",
            "EQDN", "URUL", "TOTP", "SHAR", "ENDM"
        };
        ...
        public static readonly byte[] RsaD = (
            ...
            "jPj1S0j2TnGzR0KMC3lxhqIP8NLa+Q==").Decode64();
        ...
        public static readonly byte[] RsaDP = (
            ...
            "4XTErz1srr6G7yDjCpvtHOJmMWNkmUGmdCrLe65cg5cEjxBBIV1Y0cRovF9bKuSuB6E=").Decode64();
        ...
        public static readonly byte[] RsaDQ = (
            ...
            "XmbP1GYnbQj6PmbvX+0rGx+vqeZf414CBlnAd4YjprlOA5Mm8lSWueCR9leUxKpdj+U=").Decode64();
        ...
        public static readonly byte[] RsaInverseQ = (
            ...
            "ANUGX2S9IsNmJLwvFEvocVP0WkVsLtszfUuWAMjF2Ah9pFl6CW6WCbwwPW7Ax6Q5uCA=").Decode64();
        ...
        public static readonly byte[] RsaModulus = (
            ...
            "tGTMwqXZcX1sNbWB+KQmA4egwRxU1w==").Decode64();
        ...
        public static readonly byte[] RsaP = (
            ...
            "fjBD6MUN5qm9eEvE7RavusIyUeZri1cDbbXgzaUJL0HTYAUUzcy5e4K9IJVDdkvjoG0=").Decode64();
        ...
        public static readonly byte[] RsaQ = (
            ...
            "OhUuHEdDBijcnUiW79/8eukRBzrWNblp15iT/mQJaDsEn61bzylmomQrVftJtLs4p9M=").Decode64();
        ...
        public static readonly Account[] Accounts = new[] {
            ...
            new Account("1872746086", "Lubowitz LLC", "maxine@ebertmckenzie.biz", "qrcl02", "http://considineheidenreich.name/name.christiansen", "(none)"),
            ...
            new Account("1872746286", "Bahringer, Prohaska and Mills", "merritt_reilly@lynch.info", "dyX^xZ3HTKsqFIMeA", "http://schuppe.com/rosetta.yundt", "(none)"),
            ...
            new Account("1872746436", "Swaniawski, Will and Gaylord", "jeramie.ohara@nader.org", "quia", "http://oreilly.info/dahlia_donnelly", "(none)"),
