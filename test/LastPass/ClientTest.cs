...
namespace PasswordManagerAccess.Test.LastPass
{
    public class ClientTest : TestBase
    {
        ...
        public async Task OpenVault_returns_accounts()
        {
            ...
            var accounts = await Client.OpenVault(Username, Password, ClientInfo, null, flow, ParserOptions.Default, CancellationToken.None);
        ...
        [Fact]
        public async Task OpenVault_returns_accounts_with_otp_and_rememeber_me()
        {
            // Arrange
            var flow = new RestFlow()
                .Post(IterationResponse)
        ...
        [Fact]
        public async Task OpenVault_returns_accounts_with_oob_and_rememeber_me()
        {
            // Arrange
            var flow = new RestFlow()
                .Post(IterationResponse)
        ...
        public async Task OpenVault_throws_on_invalid_username()
        {
            ...
            // Act
            var act = () => Client.OpenVault(Username, Password, ClientInfo, null, flow, ParserOptions.Default, CancellationToken.None);
        ...
        public async Task OpenVault_throws_on_canceled_otp()
        {
            ...
            // Act
            var act = () => Client.OpenVault(Username, Password, ClientInfo, GetCancelingUi(), flow, ParserOptions.Default, CancellationToken.None);
        ...
        public async Task OpenVault_throws_on_failed_otp()
        {
            ...
            // Act
            var act = () =>
                Client.OpenVault(Username, Password, ClientInfo, GetOtpProvidingUi(), flow, ParserOptions.Default, CancellationToken.None);
        ...
        public async Task OpenVault_throws_on_failed_oob()
        {
            ...
            // Act
            var act = () =>
                Client.OpenVault(Username, Password, ClientInfo, GetWaitingForOobUi(), flow, ParserOptions.Default, CancellationToken.None);
        ...
        public async Task Login_returns_session_and_rest_client()
        {
            ...
            // Act
            var (session, rest) = await Client.Login(Username, Password, ClientInfo, null, flow, CancellationToken.None);
        ...
        public async Task Login_returns_session_and_rest_client_with_otp()
        {
            ...
            // Act
            var (session, rest) = await Client.Login(Username, Password, ClientInfo, GetOtpProvidingUi(), flow, CancellationToken.None);
        ...
        public async Task Login_returns_session_and_rest_client_with_oob()
        {
            ...
            // Act
            var (session, rest) = await Client.Login(Username, Password, ClientInfo, GetWaitingForOobUi(), flow, CancellationToken.None);
        ...
        public async Task ApproveOob_calls_Ui_ApproveLastPassAuth()
        {
            ...
            // Act
            await Client.ApproveOob(Username, LastPassAuthOobParameters, ui, null, CancellationToken.None);
        ...
        public async Task ApproveOob_calls_Ui_ApproveDuo()
        {
            ...
            // Act
            await Client.ApproveOob(Username, DuoOobParameters, ui, null, CancellationToken.None);
        ...
        public async Task ApproveOob_calls_Ui_ApproveSalesforceAuth()
        {
            ...
            // Act
            await Client.ApproveOob(Username, SalesforceAuthOobParameters, ui, null, CancellationToken.None);
        ...
        {
            // Arrange/Act
            var act = () => Client.ApproveOob(Username, new Dictionary<string, string>(), null, null, CancellationToken.None);
        ...
        public async Task ApproveOob_throws_on_unknown_method()
        {
            // Arrange/Act
            var act = () =>
                Client.ApproveOob(Username, new Dictionary<string, string> { ["outofbandtype"] = "blah" }, null, null, CancellationToken.None);
        ...
        public async Task ApproveOob_throws_on_missing_duo_v1_parameters(string name)
        {
            ...
            // Act
            var act = () => Client.ApproveOob(Username, parameters, null, null, CancellationToken.None);
