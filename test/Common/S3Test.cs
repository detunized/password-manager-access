...
namespace PasswordManagerAccess.Test.Common
{
    public class S3Test
    {
        ...
        public void MakeHeaders_returns_correct_headers()
        {
            ...
            Assert.Equal(
                "AWS4-HMAC-SHA256 Credential=ASIASIFWL2FI3L4O3POJ/20200322/us-east-1/s3/aws4_request, Signed"
            ...
            Assert.Equal(
                "aws-sdk-dotnet-45/3.3.110.30 aws-sdk-dotnet-core/3.3.104.32 .NET_Runtime/4.0 .NET_Framework"
            ...
            Assert.Equal("e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855", headers["X-Amz-Content-SHA256"]);
