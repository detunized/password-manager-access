...
namespace PasswordManagerAccess.Test.Common
{
    public class ChaCha20Test
    {
        ...
        {
            Exceptions.AssertThrowsInternalError(() => new ChaCha20(new byte[1337], new byte[12]),
        ...
        {
            Exceptions.AssertThrowsInternalError(() => new ChaCha20(new byte[32], new byte[1337]),
                                                 "Nonce must be 12 bytes");
        }

        // Test vectors from https://github.com/golang/crypto/blob/master/chacha20/vectors_test.go
        [Theory]
        [InlineData("b6a3a89de64abf3aae9cf1a207c768101e80e472925d16ce8f02e761573dac82",
                    "1733d194b3a2b6063600fe3f",
                    "",
                    "")]
        [InlineData("2be077349f80bf45faa1f427e81d90dbdc90a1d8d4212c1dacf2bd870000bfdf",
                    "ddfa69041ecc3feeb077cf45",
                    "23dbad0780",
                    "415a3e498d")]
        [InlineData("254c12e973a3d14fbbf7457964f0d5ee5d18c42913cf9a3c67a3944c532c2c7c",
                    "496b2a516daff98da5a23653",
                    "f518831fab69c054a6",
                    "cfe40f63f81391484b")]
        [InlineData("205082fc0b41a45cd085527d9d1c0a16410b47152a743436faa74ae67ae60bca",
                    "9e7a69ca17672f6b209285b7",
                    "805fad1d62951537aeed9859",
                    "47bd303f93c3ce04bce44710")]
        [InlineData("ef2d6344a720e4a58f2ac10f159ab76314e37d3316bf2fb857bc043127927c67",
                    "b33dedcd7f0a77359bdeae06",
                    "f4e8a7577affb841cf48392cf5df",
                    "f445c0fb7e3d5bfdab47090ddee6")]
        [InlineData("a831bd347ef40828f9198b9d8396f54d48435831454aa734a274e10ddcc7d429",
                    "b1508a348092cc4ace14608d",
                    "1179b71ec4dc34bd812f742b5a0b27",
                    "cc7f80f333c647d6e592e4f7ecc834")]
        [InlineData("ed793ce92b1689ce66836a117f65dcec981dc85b522f5dffbb3e1f172f3f7750",
                    "034775c821c58891a6e88cac",
                    "7bd94943d55392d0311c413ac755ce0347872ba3",
                    "c43665de15136af232675d9d5dbbeca77f3c542a")]
        [InlineData("b3d542358ffd7b1ff8ab3810ece814729356d0edbd63e66006d5e5e8a223a9ee",
                    "cb55869aa56e9d6e5e70ad5d",
                    "1505f669acc5ad9aaa0e993ba8c24e744d13655e1f",
                    "26cad1ccf4cf4c49b267ab7be10bc2ffa3ba66bc86")]
        [InlineData("d6b18ae2473d3be8ca711267ffbc77b97644f6a2b4791d31d0910d180c6e1aec",
        ...
        [InlineData("bba26ce4efb56ad06b96e2b02d0cdd549ad81588a9306c421e0f5b0175ae4b25",
        ...
        [InlineData("a76d5c79dcaab18c9a3542a0272eea95c45382122f59bcaa10e8910371d941f6",
        ...
        [InlineData("f78c6fa82b1ab48d5631e0e0598aad3dbad1e4b338fbf6759d7094dbf334dbc3",
        ...
        [InlineData("a0076c332ba22e4a462f87a8285e7ba43f5e64be91651c377a23dcd28095c592",
        ...
        [InlineData("2e4c1a78e255ab2743af4a8101ab0b0ae02ce69dd2032b47e818eedf935b858b",
        ...
        [InlineData("3277fc62f46cf0ced55ef4a44f65962f6e952b9ff472b542869cb55b4f78e435",
        ...
        [InlineData("8f7a652b5d5767fe61d256aa979a1730f1fffcae98b68e9b5637fe1e0c45eab4",
        ...
        [InlineData("e7d8148613049bdefab4482a44e7bdcb5edc5dad3ed8449117d6d97445db0b23",
        ...
        [InlineData("74e7fc53bf534b9a3441615f1494c3a3727ca0a81123249399ecae435aeb6d21",
        ...
        [InlineData("393e211f141d26562c7cfc15c5ccfe21c58456a9060560266bc0dcdab010c8f2",
        ...
        public void ProcessBytes_works_correctly_with_any_length()
        {
            ...
            {
                var output = new byte[size];
                new ChaCha20("254c12e973a3d14fbbf7457964f0d5ee5d18c42913cf9a3c67a3944c532c2c7c".DecodeHex(),
        ...
        public void ProcessBytes_respects_input_offset_and_size()
        {
            ...
            {
                var actualInput = new byte[padding].Concat(input).ToArray();
                for (var size = 0; size < input.Length; ++size)
                {
                    var output = new byte[size];
                    new ChaCha20("254c12e973a3d14fbbf7457964f0d5ee5d18c42913cf9a3c67a3944c532c2c7c".DecodeHex(),
        ...
        public void ProcessBytes_throws_on_invalid_input_buffer_size_offset(int bufferSize, int offset, int size)
        {
            Exceptions.AssertThrowsInternalError(
                () => new ChaCha20(new byte[32], new byte[12])
                    .ProcessBytes(new byte[bufferSize], offset, size, new byte[Math.Max(0, size)], 0),
        ...
        public void ProcessBytes_throws_on_invalid_output_buffer_size_offset(int bufferSize, int offset, int size)
        {
            Exceptions.AssertThrowsInternalError(
                () => new ChaCha20(new byte[32], new byte[12])
                    .ProcessBytes(new byte[size], 0, size, new byte[bufferSize], offset),
