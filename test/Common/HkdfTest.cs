...
namespace PasswordManagerAccess.Test.Common
{
    public class HkdfTest
    {
        ...
        {
            var result = Hkdf.Generate(ikm: tc.Ikm.DecodeHex(), salt: tc.Salt.DecodeHex(), info: tc.Info.DecodeHex(), byteCount: tc.ByteCount);
        ...
        public static readonly TestCase[] TestCasesData =
        {
            new TestCase
            {
                ...
                ByteCount = 42,
                Expected = "3cb25f25faacd57a90434f64d0362f2a2d2d0a90cf1a5a4c5db02d56ecc4c5bf34" + "007208d5b887185865",
            },
            new TestCase
            {
                Ikm =
