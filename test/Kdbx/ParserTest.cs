...
namespace PasswordManagerAccess.Test.Kdbx
{
    public class ParserTest : TestBase
    {
        ...
        public void Parse_bytes_returns_accounts(string fixture)
        {
            var db = GetBinaryFixture(fixture, "kdbx");
        ...
        [InlineData("kdbx4-aes-twofish")]
        [InlineData("kdbx4-argon2-aes-1k-block")]
        public void Parse_streams_returns_accounts(string fixture)
        {
        ...
        public void Parse_bytes_with_keyfile_returns_accounts(string keyfileName, string keyfileExtension)
        {
            var db = GetBinaryFixture("kdbx4-with-keyfile", "kdbx");
            var keyfile = GetBinaryFixture(keyfileName, keyfileExtension);
        ...
        [InlineData("keyfile-legacy-binary", "bin")]
        [InlineData("keyfile-legacy-hex", "txt")]
        public void Parse_streams_with_keyfile_returns_accounts(string keyfileName, string keyfileExtension)
        {
        ...
        [InlineData("keyfile-legacy-binary", "bin")]
        [InlineData("keyfile-legacy-hex", "txt")]
        public void ReadKeyfile_bytes_returns_keyfile_content(string keyfileName, string keyfileExtension)
        {
            var bytes = GetBinaryFixture(keyfileName, keyfileExtension);
            var keyfile = Parser.ReadKeyfile(bytes);
        ...
        [InlineData("keyfile-legacy-binary", "bin")]
        [InlineData("keyfile-legacy-hex", "txt")]
        public void ReadKeyfile_stream_returns_keyfile_content(string keyfileName, string keyfileExtension)
        {
