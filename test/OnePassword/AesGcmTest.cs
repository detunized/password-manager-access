    ...
    public class AesGcmTest
    {
        ...
        public void Encrypt_throws_on_invalid_key_length()
        {
            Exceptions.AssertThrowsInternalError(
                () => AesGcm.Encrypt(key: new byte[13], plaintext: new byte[16], iv: new byte[12], authData: new byte[0]),
                "key must"
            );
        }
        ...
        {
            Exceptions.AssertThrowsInternalError(
                () => AesGcm.Encrypt(key: new byte[32], plaintext: new byte[16], iv: new byte[13], authData: new byte[0]),
                "iv must"
            );
        }
        ...
        {
            Exceptions.AssertThrowsInternalError(
                () => AesGcm.Decrypt(key: new byte[13], ciphertext: new byte[16], iv: new byte[12], authData: new byte[0]),
                "key must"
            );
        }
        ...
        {
            Exceptions.AssertThrowsInternalError(
                () => AesGcm.Decrypt(key: new byte[32], ciphertext: new byte[13], iv: new byte[12], authData: new byte[0]),
                "ciphertext must"
            );
        }
        ...
        {
            Exceptions.AssertThrowsInternalError(
                () => AesGcm.Decrypt(key: new byte[32], ciphertext: new byte[16], iv: new byte[13], authData: new byte[0]),
                "iv must"
            );
        }
        ...
        public struct TestCase
        {
            ...
            public TestCase(string key, string plaintext, string iv, string authData, string ciphertext, string tag, string hashKey, string gHash)
            {
                Key = key.DecodeHex();
