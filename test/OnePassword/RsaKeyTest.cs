    ...
    public class RsaKeyTest: TestBase
    {
        ...
        public void Decrypt_decrypts_OAEP_SHA1_encrypted_ciphertext()
        {
            var enc = new Encrypted(
                ...
                iv: null,
                ciphertext: ("plF49e+3R0IpxBqWinosrPxWS8GdzKULvo4myIS1Gam5LCl1TmvvtntAiwOaL+/x8Ie7JApxksrpzrg9UAIaJeO" +
                             ...
                             "+IVXc5niMzTMYvRb5rIEiNm3WSX7EteqaU9T46ytm9748ILQNeuGSjzIqhO4H7mO47/e8wdEh3WZk8Alg==").Decode64());
        ...
        public void Decrypt_decrypts_OAEP_SHA256_encrypted_ciphertext()
        {
            var enc = new Encrypted(
                ...
                container: "b5+jwk+json",
                iv: null,
                ciphertext: ("R2wRx7neV9M/hMyWhr6heE43Q48xL+6lZuy9k03+G0FVPmXsVPRK4q7nWq6UDVwcj42nxMychMKfurCuecLEd+h" +
                             ...
                             "im4UBOwE8f1axTDSYtKLJ31rr+z5bHxraUMzz96BnOmIzsZ2jj0fHrZBsBUs1L5Bg5XmGwHTz01z4HQ9A==").Decode64());
        ...
        {
            var enc = new Encrypted(keyId: "invalid-id",
                                    scheme: "RSA-OAEP",
                                    container: "b5+jwk+json",
                                    iv: null,
