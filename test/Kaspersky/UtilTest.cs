...
namespace PasswordManagerAccess.Test.Kaspersky
{
    public class UtilTest
    {
        ...
        public void DeriveMasterPasswordAuthKey_returns_derived_key()
        {
            ...
            Assert.Equal(
                (
                    "d6602e5364ffa30389d9bab817919919ed417aabce1723ebc554099a34375253"
                    + "fee450daa7b0d9959672398c79cde5736d020c73db661f12da6c2ede7c747e2c"
                ).DecodeHex(),
                key
            );
        }
        ...
        {
            var key = Util.DeriveEncryptionKey("Password123!", new DatabaseInfo(2, 1500, "39b56347c16c94c36553fd74a7cd2cb1".DecodeHex()));

            Assert.Equal("d8f2bfe4980d90e3d402844e5332859ecbda531ab24962d2fdad4d39ad98d2f9".DecodeHex(), key);
        }
    }
}
