    ...
    public class SrpTest
    {
        ...
        public void GenerateProofs_returns_proofs()
        {
            ...
            var expectedClientEphemeral = (
                ...
                + "el/Q7+phz3ph+605Rx6LxWqZJXs2n5u50iskPSSw4aeiw=="
            ).Decode64();
            ...
            var expectedClientProof = (
                ...
                + "xPzZzSi1Dvr73g8YchIxEugqOOSQ/tM6SnVwvKbWKQyiA=="
            ).Decode64();
            ...
            var expectedServerProof = (
                ...
                + "G9hZqDm7DFQi/1u/NY4BGMzQCIMNb92khCsUkioHuqg7A=="
            ).Decode64();
        ...
        [InlineData(
            ...
            "password",
            "username",
            ""
        )]
        [InlineData(
            1,
            "password",
        ...
        [InlineData(
            ...
            "password",
            "username",
            ""
        )]
        [InlineData(
            4,
            "password",
