    ...
    internal static class Util
    {
        ...
        public static byte[] RecoveryWordsToMasterKey(string[] recoveryWords)
        {
            ...
            foreach (var word in recoveryWords)
            {
                ...
                if (index < 0)
                    throw new InternalErrorException($"Recovery word '{word}' is invalid");

                var bitsAvailable = 11;
                while (bitsAvailable > 0)
                {
                    var bitsNeeded = 8 - bitsStored;
                    var numBits = Math.Min(bitsNeeded, bitsAvailable);
                    accumulator <<= numBits;
                    accumulator |= index >> (bitsAvailable - numBits);
                    bitsStored += numBits;
                    bitsAvailable -= numBits;

                    if (bitsStored == 8)
                    {
                        key[byteIndex] = (byte)accumulator;
                        byteIndex += 1;
                        bitsStored = 0;
                    }
                }
        ...
        internal static readonly string[] WordListEn =
        {
            // A
            ...
            "bonus", "book", "boost", "border", "boring", "borrow", "boss", "bottom", "bounce", "box", "boy", "bracket",
            "brain", "brand", "brass", "brave", "bread", "breeze", "brick", "bridge", "brief", "bright", "bring",
            ...
            // O
            "oak", "obey", "object", "oblige", "obscure", "observe", "obtain", "obvious", "occur", "ocean", "october",
            "odor", "off", "offer", "office", "often", "oil", "okay", "old", "olive", "olympic", "omit", "once", "one",
            "onion", "online", "only", "open", "opera", "opinion", "oppose", "option", "orange", "orbit", "orchard",
            ...
            "pave", "payment", "peace", "peanut", "pear", "peasant", "pelican", "pen", "penalty", "pencil", "people",
            ...
            "place", "planet", "plastic", "plate", "play", "please", "pledge", "pluck", "plug", "plunge", "poem",
            ...
            // W
            "wage", "wagon", "wait", "walk", "wall", "walnut", "want", "warfare", "warm", "warrior", "wash", "wasp",
